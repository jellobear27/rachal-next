    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 pt-10 items-center">
        <div className="mb-10">
          {" "}
          {/* Adjusted margin */}
          <p className="text-[#f5f3f4] font-bold text-[13px]">
            HELLO THERE, WELCOME!
          </p>
          ...
          <p className="text-white text-[18px] font-bold">
            I'm dedicated to providing comprehensive tax solutions tailored to
            meet your specific needs. Let me assist you in navigating and
            optimizing your tax requirements effectively!
          </p>
          <br></br>
          <div>
            <video
