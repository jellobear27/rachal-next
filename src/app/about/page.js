...
function about() {
  return (
    <div>
      ...
      <div className="my-6"></div>
      <p className="px-4 py-2 text-gray-800 font-medium text-sm lg:text-base leading-relaxed lg:leading-loose lg:px-20">
